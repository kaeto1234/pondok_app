                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($pendaftarans as $pendaftaran)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">{{ $pendaftaran->tahunAjaran->nama_tahun ?? '-' }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500">
                                {{ $pendaftaran->tanggal_daftar->format('d M Y H:i') }}</td>
                            <td class="px-6 py-4">
                                ...
                                @elseif($pendaftaran->status == 'diverifikasi')
                                    <span
                                        class="px-2 py-1 text-xs font-semibold bg-green-100 text-green-700 rounded-full">Diverifikasi</span>
                                @else
                                    <span
